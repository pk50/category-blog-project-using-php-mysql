...
<html lang="en">
   ...
   <div class="container-fluid p-0 position-relative">
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<a class="position-absolute bags"><button class="btn btn-info" data-toggle="modal" data-target="#signup">Luggage / Bags</button></a>
				<a class="position-absolute out"><button class="btn btn-info" data-toggle="modal" data-target="#stop">Log Out</button></a>
			<div class="carousel-item active">
				<img class="w-100" src="assets/images/lg5.jpg" alt="First slide" height="500" width="400">
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/lg4.jpg" alt="Second slide" height="500" width="400">
				<div class="carousel-caption">
					<h5>SLIDE 2</h5>
					<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
				</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/lg3.jpg" alt="Third slide" height="500" width="400">
					<div class="carousel-caption">
						<h5>SLIDE 3</h5>
						<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
					</div>
 ...
 <?php 
  ...
  $select ="SELECT * FROM cb_blog WHERE category_id = 42 AND `users_id`='".$id."'";
