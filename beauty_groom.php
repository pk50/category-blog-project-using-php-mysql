...
<html lang="en">
   ...
   <div class="container-fluid p-0 position-relative">
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<a class="position-absolute beauty"><button class="btn btn-info" data-toggle="modal" data-target="#signup">Beauty / Makeup</button></a>
 ...
 <?php 
  ...
  $select ="SELECT * FROM cb_blog WHERE category_id = 41 AND `users_id`='".$id."'";
