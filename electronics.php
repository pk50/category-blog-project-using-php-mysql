...
<html lang="en">
   ...
   <div class="container-fluid p-0 position-relative">
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				...
				<a class="position-absolute electronics"><button class="btn btn-info" data-toggle="modal" data-target="#signup">Electronics</button></a>
				<a class="position-absolute out"><button class="btn btn-info" data-toggle="modal" data-target="#stop">Log Out</button></a>
			<div class="carousel-item active">
				<img class="w-100" src="assets/images/el6.jpg" alt="First slide" height="500" width="400">
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/el1.jpg" alt="Second slide" height="500" width="400">
				<div class="carousel-caption">
					<h5>SLIDE 2</h5>
					<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
				</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/el3.png" alt="Third slide" height="500" width="400">
					<div class="carousel-caption">
						<h5>SLIDE 3</h5>
						<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
					</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/el2.jpg" alt="Fourth slide" height="500" width="400">
				<div class="carousel-caption">
					<h5>SLIDE 4</h5>
					<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
				</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/el4.jpg" alt="Fifth slide" height="500" width="400">
					<div class="carousel-caption">
						<h5>SLIDE 5</h5>
						<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
					</div>
 ...
 <?php 
  ...
  $select ="SELECT * FROM cb_blog where category_id = 38 AND `users_id`='".$id."'";
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<div class="modal-body">
			<div class="media">
				<img src="uploads/<?php echo $res['image']; ?>" class="align-self-center mr-3 " id="img_d" height="250" width="250" alt="...">
