    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><strong style="font-size:32px;"> ADMIN </strong></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
						...
						<tr>
							...
							<td><a href="delete.php?user_id=<?php echo $res['id'];?>"><i class="ti-trash"></i></a></td>
							<td><a href="edit.php?user_id=<?php echo $res['id'];?>"><i class="fa fa-edit"></i></a></td>
							<td><a href="add_category.php">Add</a></td>
							<td></td>
					</tr>	
					<?php }
					?> 
