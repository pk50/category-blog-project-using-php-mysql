...
<?php
		...
		$select="SELECT cb_blog.*,cb_categories.category FROM cb_blog JOIN cb_categories ON cb_categories.id=cb_blog.category_id" AND "SELECT cb_blog.*,cb_users.name FROM cb_blog JOIN cb_users ON cb_users.id=cb_blog.user";
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
						...
						<tr>
							...
							<td><?php  echo $res['counrty']; ?></td>
							<td><a href="add_users.php"><button class="btn">Add</button></a></td>
							<td><a href="delete_users.php?user_id=<?php echo $res['id'];?>"><i class="ti-trash"></i></a></td>
							<td><a href="edit_users.php?user_id=<?php echo $res['id'];?>"><i class="fa fa-edit"></i></a></td>
						</tr>	
					<?php }
					?> 
