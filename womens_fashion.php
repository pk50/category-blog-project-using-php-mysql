...
<html lang="en">
   ...
   <div class="container-fluid p-0 position-relative">
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<a  class="position-absolute welcome_user text-white bg-primary p-2"><?php echo strtoupper($_SESSION['my_user_name']);?></a>
				<a class="position-absolute women_fashion"><button class="btn btn-info" data-toggle="modal" data-target="#signup">Women's fashion</button></a>
				<a class="position-absolute out"><button class="btn btn-info" data-toggle="modal" data-target="#stop">Log Out</button></a>
			<div class="carousel-item active">
				<img class="w-100" src="assets/images/wo1.jpg" alt="First slide" height="500" width="400">
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/wo2.jpg" alt="Second slide" height="500" width="400">
				<div class="carousel-caption">
					<h5>SLIDE 2</h5>
					<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
				</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/wo6.jpg" alt="Third slide" height="500" width="400">
					<div class="carousel-caption">
						<h5>SLIDE 3</h5>
						<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
					</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/wo3.jpg" alt="Fourth slide" height="500" width="400">
				<div class="carousel-caption">
					<h5>SLIDE 4</h5>
					<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
				</div>
			...
			<div class="carousel-item">
				<img class="w-100" src="assets/images/wo5.jpg" alt="Fifth slide" height="500" width="400">
					<div class="carousel-caption">
						<h5>SLIDE 5</h5>
						<p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
					</div>
 ...
 // $user="user";
  ...
  $select ="SELECT * FROM cb_blog WHERE category_id = 36 AND `users_id`='".$id."'";
  $query = mysqli_query($conn,$select);
  
 ?>
 <!--//PHP -->
		<div class="container-fluid p-5">
			<h3 class="text-center"> Blog's view</h3>
				...
				<?php } ?>
					<div class="card col-md-3 mx-md-4 ml-md-1 my-2 justify-content-center" >
							<a href="user_index.php">
								...
								<div class="overlay">
									<div class="text-right"><strong>Add Blog</strong>
									</div>
							</a>
								</div>
					</div>
		...
		<div class="modal-body">
			<div class="media">
				...
				<div class="media-body my-5 ">
					...
					<h3 id="title_d" class="text-center">title</h3>
					<!--<h3 id="cat_d">Category</h3>-->
					<p id="des_d" class="text-center">description</p>
				</div>
			</div>
		</div>
    </div>
...
<script>
		$(document).ready(function(){
			...
			$('.view').click(function(){
				...
				$.ajax({
					url:"fetch_womens_fashion_data.php",
					data:{id:id},
					method:"post",
					dataType:"json",
					success:function(res){
						...
						$.each(res, function(key, value){
							$("#img_d").attr("src","uploads/"+value.image);
							//$("#user_d").html(value.user);
							$("#title_d").html(value.title);
							//$("#cat_d").html(value.category_id);
